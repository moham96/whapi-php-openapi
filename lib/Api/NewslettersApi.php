...
class NewslettersApi
{
     ...
     * @param  string $newsletter_id Newsletter ID (required)
     * @param  float $count Count of objects to return (optional, default to 100)
     * @param  float $before Top limit for selection (optional)
     ...
     */
    public function getMessagesNewsletter($newsletter_id, $count = 100, $before = null, string $contentType = self::contentTypes['getMessagesNewsletter'][0])
    {
        list($response) = $this->getMessagesNewsletterWithHttpInfo($newsletter_id, $count, $before, $contentType);
        return $response;
    }
     ...
     */
    public function getMessagesNewsletterWithHttpInfo($newsletter_id, $count = 100, $before = null, string $contentType = self::contentTypes['getMessagesNewsletter'][0])
    {
        $request = $this->getMessagesNewsletterRequest($newsletter_id, $count, $before, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessagesNewsletterAsync($newsletter_id, $count = 100, $before = null, string $contentType = self::contentTypes['getMessagesNewsletter'][0])
    {
        return $this->getMessagesNewsletterAsyncWithHttpInfo($newsletter_id, $count, $before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessagesNewsletterAsyncWithHttpInfo($newsletter_id, $count = 100, $before = null, string $contentType = self::contentTypes['getMessagesNewsletter'][0])
    {
        $returnType = '\OpenAPI\Client\Model\MessagesList';
        $request = $this->getMessagesNewsletterRequest($newsletter_id, $count, $before, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMessagesNewsletterRequest($newsletter_id, $count = 100, $before = null, string $contentType = self::contentTypes['getMessagesNewsletter'][0])
    {
