...
| [**getContactProfile()**](ContactsApi.md#getContactProfile) | **GET** /contacts/{ContactID}/profile | Contact profile |
...
```php
checkExist($contact_id): \OpenAPI\Client\Model\ResponseSuccess
```
